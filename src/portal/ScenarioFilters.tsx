...
const labelCls = 'block text-[11px] font-bold uppercase tracking-[0.12em] text-ink-soft';
...
export function ScenarioFilters({
  ...
  const set = <K extends keyof ScenarioFilterState>(key: K, value: ScenarioFilterState[K]) =>
