import { TARGET_GROUPS, type AdminScenarioRow, type TargetGroup } from './types.ts';
...
export function reviewChecklist(row: AdminScenarioRow): ReviewCheck[] {
  const checks: ReviewCheck[] = [
    ...
    },
    {
      id: 'blame',
      question:
        'Does the feedback describe the offender’s tactic rather than the participant’s mistake?',
