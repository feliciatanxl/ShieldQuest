...
import { AiAssist, AiAssistedBadge, type AiField, type AiSuggestion } from './AiAssist.tsx';
import { reviewChecklist } from './scenario-insights.ts';
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="flex items-start gap-2 text-[12px] leading-relaxed text-ink-soft">
        ...
        <span>
          Recording a decision does not change what participants see. Publishing a revised scenario
          is a separate, deliberate step. Simulated session data.
        </span>
      </p>
    </div>
  );
