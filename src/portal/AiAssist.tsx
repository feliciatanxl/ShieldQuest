        ...
        <div className="flex items-start gap-2.5">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[12px] leading-relaxed text-ink-muted">
              Drafting for <strong className="font-bold text-ink">{row.category}</strong> ·{' '}
      ...
      <div className="mt-3">
        ...
        {limitsOpen && (
          <ul className="mt-2.5 space-y-1.5 rounded-[10px] border border-line bg-surface p-3.5 text-[12px] leading-relaxed text-ink-muted">
            ...
            <li>
              <strong className="font-bold text-ink">Accepted one field at a time.</strong> There is
              no "use everything" — you have to have read a suggestion to take it.
            </li>
            <li>
            ...
            <li>
              <strong className="font-bold text-ink">
                Will not write statistics or cite sources.
              </strong>{' '}
              Every figure in this product traces to a named Singapore Police Force brief, added by
              a person.
            </li>
            <li>
      ...
      {drafted && (
        <div aria-live="polite" className="mt-4 space-y-2.5">
          {visible.length === 0 ? (
            ...
            visible.map((s) => (
              <article key={s.field} className="rounded-[10px] border border-line bg-surface p-3.5">
