          ...
          >
            <div>
              <div className="flex items-center justify-between text-xs">
                <span
                  className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider ${item.categoryColor}`}
                >
                  {item.category}
                </span>
              ...
              <p className="mt-1.5 text-xs text-[var(--sq-ink-muted)] leading-relaxed">
                {item.desc}
              </p>
            </div>
