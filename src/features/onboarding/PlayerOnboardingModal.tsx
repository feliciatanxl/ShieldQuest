...
export function PlayerOnboardingModal({ open, onComplete }: PlayerOnboardingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy-950/80 p-4 backdrop-blur-md">
      <div className="relative flex max-h-[90vh] w-full max-w-lg flex-col justify-between overflow-hidden rounded-[24px] border-2 border-white/20 bg-navy-900 text-white shadow-2xl">
        {/* Top Progress Bar */}
        ...
        <div className="flex-1 overflow-y-auto p-6 text-center">
          ...
          {step === 1 && (
            <div className="py-4">
              <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[24px] bg-gradient-to-br from-amber-400 to-amber-600 text-[var(--sq-ink)] shadow-xl shadow-amber-500/20">
              ...
              <p className="mt-3 text-sm font-medium leading-relaxed text-[var(--sq-ink-muted)]">
          ...
          {step === 2 && (
            <div className="py-4">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-[16px] bg-civic-500/20 text-civic-400">
                <Zap className="h-8 w-8" />
              </div>
              <h2 className="mt-5 text-2xl font-black uppercase tracking-tight text-white">
                Your City Mission
              </h2>
              <p className="mt-2 text-xs font-semibold text-[var(--sq-ink-muted)]">
                Scams and digital crime are evolving fast. In this mission, you will:
              </p>
              <div className="mt-6 space-y-3 text-left">
                <div className="flex items-start gap-3 rounded-[16px] border border-white/10 bg-white/5 p-3.5">
          ...
          {step === 3 && (
            <div className="py-2">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[16px] bg-teal-500/20 text-teal-400">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 text-left">
                <div className="rounded-[16px] border border-amber-400/30 bg-amber-500/10 p-2.5">
                ...
                <div className="rounded-[16px] border border-blue-400/30 bg-blue-500/10 p-2.5">
                  ...
                  <p className="mt-0.5 text-[11px] text-[var(--sq-ink-muted)]">Verify seller credentials</p>
                </div>
                <div className="rounded-[16px] border border-indigo-400/30 bg-indigo-500/10 p-2.5">
                  <span className="text-[10px] font-black text-indigo-300">EVALUATE · ByteBuddy</span>
                  <p className="mt-0.5 text-[11px] text-[var(--sq-ink-muted)]">Check app permissions</p>
                </div>
                <div className="rounded-[16px] border border-rose-400/30 bg-rose-500/10 p-2.5">
                  <span className="text-[10px] font-black text-rose-300">LEAD · Beacon</span>
                  <p className="mt-0.5 text-[11px] text-[var(--sq-ink-muted)]">Constructive peer guidance</p>
                </div>
                <div className="rounded-[16px] border border-emerald-400/30 bg-emerald-500/10 p-2.5">
                  <span className="text-[10px] font-black text-emerald-300">DEFEND · Shieldfin</span>
                  <p className="mt-0.5 text-[11px] text-[var(--sq-ink-muted)]">Safeguard bank accounts</p>
                </div>
              </div>
            </div>
          )}
          ...
          {step === 4 && (
            <div className="py-4">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[16px] bg-amber-500/20 text-amber-400">
              ...
              <div className="mt-6 space-y-3 text-left">
                ...
                <div className="rounded-[16px] border border-rose-400/20 bg-rose-500/10 p-4">
          ...
          {step === 5 && (
            <div className="py-4">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[16px] bg-civic-500/20 text-civic-400">
              ...
              <div className="mt-6 grid grid-cols-3 gap-2.5 text-center">
                <div className="rounded-[16px] border border-white/10 bg-white/5 p-3">
                  ...
                  <p className="mt-1 text-[10px] text-[var(--sq-ink-muted)]">Private situational review</p>
                </div>
                <div className="rounded-[16px] border border-white/10 bg-white/5 p-3">
                  <div className="text-sm font-black text-teal-400">VOTE</div>
                  <p className="mt-1 text-[10px] text-[var(--sq-ink-muted)]">Anonymous squad poll</p>
                </div>
                <div className="rounded-[16px] border border-white/10 bg-white/5 p-3">
                  <div className="text-sm font-black text-civic-400">EXPLAIN</div>
                  <p className="mt-1 text-[10px] text-[var(--sq-ink-muted)]">Debate different perspectives</p>
                </div>
              </div>
              <p className="mt-6 text-xs text-[var(--sq-ink-muted)] font-medium">
                ...
                {AVAILABLE_TOKENS.map((tid) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center justify-center rounded-[16px] border-2 p-3 transition ${
                        isSelected
                    ...
                    >
                      ...
                      <span className="mt-2 text-[10px] font-black uppercase tracking-wider text-[var(--sq-ink-muted)]">
          ...
          {step === 7 && (
            <div className="py-6">
              <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[24px] bg-gradient-to-br from-emerald-400 to-emerald-600 text-[var(--sq-ink)] shadow-xl shadow-emerald-500/25">
                <Sparkles className="h-10 w-10" />
              </div>
              <h2 className="mt-6 text-2xl font-black uppercase text-white">
                You Are Ready
              </h2>
              <p className="mt-3 text-sm text-[var(--sq-ink-muted)] font-medium leading-relaxed">
        ...
        <div className="flex items-center justify-between border-t border-white/10 bg-navy-950/60 p-4">
          {step > 1 ? (
            <button
              type="button"
              onClick={handleBack}
              className="inline-flex items-center gap-1.5 rounded-[10px] border border-white/20 px-4 py-2.5 text-xs font-bold text-[var(--sq-ink-muted)] hover:bg-white/10"
            >
          ...
          <button
            type="button"
            onClick={handleNext}
            className="inline-flex items-center gap-2 rounded-[10px] bg-gradient-to-r from-amber-400 to-amber-500 px-6 py-2.5 text-xs font-black uppercase tracking-wider text-[var(--sq-ink)] shadow-lg shadow-amber-400/20 hover:brightness-110 active:scale-95"
          >
